...
const docs = [
  ...
  },
  {
    ...
    "sections": [
      ...
      {
        "heading": "Verified immutable baseline",
        "paragraphs": [
  ...
  },
  {
    ...
    "sections": [
      ...
      {
        "heading": "Verified immutable baseline assets",
        "paragraphs": [
          "| Role | Baseline direct download | Bytes | SHA-256 |",
          "| --- | --- | ---: | --- |",
          ...
          "Baseline release notes: https://github.com/cafepromenade/Windows-Server-Setupper/releases/tag/windows-8.1-ba3d587a. Baseline publication run: https://github.com/cafepromenade/Windows-Server-Setupper/actions/runs/31773190945."
        ]
      },
      {
        "heading": "Unsigned baseline status",
        "paragraphs": [
      ...
      {
        "heading": "Baseline verification boundary",
        "paragraphs": [
          "The application build and installer package scripts completed for both application families for the 8.1 baseline. Tests, linting, reviews, audits, runtime UI launch, installer execution, and screenshots were intentionally not run in that expedited delivery pass. A release note that omits those facts would overstate the baseline evidence."
        ]
      }
