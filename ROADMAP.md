...
4. The Windows 8.1 baseline release and both documentation deployments are published and linked above.
...
- Earlier recovery-only WPF releases and historical local checks remain historical records; `windows-8.1-ba3d587a` is the immutable baseline named above. Resolve [the repository's latest release](https://github.com/cafepromenade/Windows-Server-Setupper/releases/latest) for current publication facts.
